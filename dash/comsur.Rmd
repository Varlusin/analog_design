...
```{r}
df <- read.csv(url("https://github.com/Varlusin/analod_design/raw/main/sp_data/cs_dc_nf.csv"))
...
layout(margin=list(l=0, r=0, t=0, b=0) , paper_bgcolor="#101010")
fig
```
...
XM2 out in vdd vdd sky130_fd_pr__pfet_01v8 L=0.15 W='5 * 1 ' nf=1
Rd  out GND 1k m=1
...
```{r}
df <- read.csv(url("https://github.com/Varlusin/analod_design/raw/main/sp_data/cs_dc_pf.csv"))
pal <- c("green", "blue", "magenta", "red", "goldenrod", "darkorange", "purple4") 
pal <- setNames(pal, unique(df$rez))
l <- list(
  title=list(text='$R_{dr}$'),
